...
import com.project.agrostore.articles.activity.ArticleDetailsActivity;
import com.project.agrostore.articles.activity.DiseasesDetailsActivity;
import com.project.agrostore.articles.adapter.CropsAdapter;
import com.project.agrostore.articles.adapter.DiseaseAdapter;
import com.project.agrostore.articles.adapter.FlowersAdapter;
import com.project.agrostore.articles.adapter.FruitsAdapter;
import com.project.agrostore.articles.adapter.HowToExpandAdapter;
import com.project.agrostore.articles.adapter.InsectControlAdapter;
...
import com.project.agrostore.databinding.FragmentEducationBinding;
...
public class EducationFragment extends Fragment implements CropsClickListener, FruitsClickListener, FlowerClickListener, ExpandClickListener, DiseasesListener, InsectControlListener {
    ...
    public void initializeagrostoreViewModel() {
        ...
        viewModel = ViewModelProviders.of(this, new agrostoreViewModelFactory(agrostoreRepository, getContext())).get(AgroViewModel.class);
    }
