...
import com.project.agrostore.databinding.FragmentShoppingBinding;
...
import com.project.agrostore.shopping.activity.AddToCartActivity;
...
public class ShoppingFragment extends Fragment implements OnProductListener {
    ...
    private void initializeagrostoreViewModel() {
