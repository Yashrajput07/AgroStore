...
import com.project.agrostore.taskmanager.receiver.SnoozeReceiver;

public class NotificationHelper extends ContextWrapper {
    public static final String channelID = "agrostore";
    ...
    public NotificationCompat.Builder getChannelNotification(Context context, String title, String desc, String date, String time, int maxIDCount) {
        ...
        snoozeButton.setAction("com.agrostore.SnoozeReceiver");
